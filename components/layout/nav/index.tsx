  ...
  return (
    <div className='fixed w-full z-50 h-[80px] items-center px-4 grid text-dark bg-transparent dark:text-white'>
      ...
      {/* <div className='hidden md:flex fixed flex-col top-[35%] right-0'>
        <ul>
          <li className='w-[160px] h-[60px] flex justify-between items-center bg-zinc-900 mr-[-100px] hover:mr-[-10px] duration-500'>
            <a
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center bg-teal-900 mr-[-100px] hover:mr-[-10px]  duration-500'>
            <a
              className='flex justify-between items-center w-full text-gray-300'
