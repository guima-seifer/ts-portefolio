...
;// CONCATENATED MODULE: ./components/repos/RepoItem.tsx
...
/* harmony default export */ const repos_RepoItem = (RepoItem);

;// CONCATENATED MODULE: ./components/repos/RepoList.tsx


function RepoList({ repos  }) {
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        className: "pt-5 grid sm:grid-cols-2 md:grid-cols-3 gap-4",
        children: repos.map((repo, index)=>/*#__PURE__*/ jsx_runtime_.jsx(repos_RepoItem, {
                ...repo
            }, index))
    });
}
/* harmony default export */ const repos_RepoList = (RepoList);
...
;// CONCATENATED MODULE: ./components/repos/UserItem.tsx
...
/* harmony default export */ const repos_UserItem = (UserItem);
...
const Repos = ({ user , repos  })=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)(section/* default */.Z, {
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx(repos_UserItem, {
                ...user
            }),
            /*#__PURE__*/ jsx_runtime_.jsx(repos_RepoList, {
                repos: repos
            })
        ]
    });
